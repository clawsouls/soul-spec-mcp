...
> "Search for coding personas and install one"
...
- ✅ Claude Cowork
- ✅ Claude Code
- ✅ Any MCP-compatible client (Cursor, etc.)
...
- [ClawSouls CLI](https://www.npmjs.com/package/clawsouls) — Full CLI with export, validate, scan
